...
exports.create = (req, res) => {
    ...
    const storeInfo = {
        ...
        open_monday: req.body.open_monday,
        open_tuesday: req.body.open_tuesday,
        open_wednesday: req.body.open_wednesday,
        open_thursday: req.body.open_thursday,
        open_friday: req.body.open_friday,
        open_saturday: req.body.open_saturday,
        open_sunday: req.body.open_sunday,
